...
DSSV 2019 Talk: [https://github.com/jharner/DSSV2019rc2](https://github.com/jharner/DSSV2019rc2)
...
* The [Littlest JupyterHub](http://tljh.jupyter.org/en/latest/) for 0--50 users on a single machine  
...
Rc$^2$ can be run locally in Docker containers and soon it will be deployed to [Digital Ocean Kubernetes](https://www.digitalocean.com/products/kubernetes/).

Rc$^2$ is designed for data scientists---not package development. It is being designed to eliminate the hidden state problem of notebooks. See the talk by [Joel Grus at JupyterCon 2018](https://docs.google.com/presentation/d/1n2RlMdmv1p25Xy5thJUhkKGvjtV-dkAIsUXP-AL4ffI/edit#slide=id.g362da58057_0_1).
